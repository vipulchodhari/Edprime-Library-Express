...
export const AddBooks = () => {
    ...
    return <div className="author-container">
        ...
        <div className='author-top'>
            ...
            <p style={{ fontSize: '12px', color: '#777777' }}>Library, Books, AddBook</p>
        </div>
            ...
            <div className="add-book-container">
                <div className='add-book-grid'>
                    <div>
                        ...
                        <input className='author-search-box addbook-search-box' type='text' name='book_title' placeholder='Enter Book Name' />
                    </div>
                    <div>
